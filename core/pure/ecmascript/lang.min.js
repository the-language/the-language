...
function ec(a){function b(){return $a.length===za}function c(){!b()||n();var d=$a[za];za++;return d}function e(d){$a[za-1]===d||n();za--}function f(d){void 0===d&&(d="");throw"TheLanguage parse ERROR!"+d;}function k(d){return" "===d||"\n"===d||"\t"===d||"\r"===d}function g(){if(b())return!1;var d=c();if(!k(d))return e(d),!1;for(;k(d)&&!b();)d=c();k(d)||e(d);return!0}function h(){if(b())return!1;var d=c(),p="";if(!W(d))return e(d),!1;for(;W(d)&&!b();)p+=d,d=c();W(d)?p+=d:e(d);return ea(p)?u(p):f("Not Atom"+
