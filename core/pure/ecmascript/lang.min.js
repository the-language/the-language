...
var F=u("\u592a\u59cb\u521d\u6838"),ya=u("\u7b26\u540d"),I=u("\u5316\u6ec5"),J=u("\u5f0f\u5f62"),Ba=u("\u7b49\u540c"),Ca=u("\u89e3\u7b97"),Da=u("\u7279\u5b9a\u5176\u7269"),L=u("\u7701\u7565\u4e00\u7269"),Ea=u("\u6620\u8868"),Fa=u("\u5982\u82e5"),M=u("\u4e00\u985e\u4f55\u7269"),Ga=u("\u662f\u975e"),Ha=u("\u5176\u5b50"),Ia=u("\u723b\u967d"),Ja=u("\u723b\u9670"),Ka=u("\u5f15\u7528"),La=u("\u61c9\u7528"),Ma=u("\u9593\u7a7a"),Na=u("\u9023\u9838"),Oa=u("\u69cb\u7269"),Pa=u("\u8b2c\u8aa4"),Qa=u("\u8a5e\u7d20"),
Ra=u("\u5217\u5e8f"),Sa=u("\u9996\u59cb"),Ta=u("\u5c3e\u672b"),Ua=u("\u4e4b\u7269"),Va=u("\u5b87\u5b99\u4ea1\u77e3"),Wa=u("\u6548\u61c9"),Xa=u("\u8a3b\u758f"),Ya=[4,F,N(Va,L)];function O(a){return[3,ya,[1,F,[1,a,z]]]}function Za(a){return O(N(M,N(I,L,a),Da))}function fb(a,b){return O(N(M,N(I,N(a),L),b))}function gb(a){return O(N(M,I,N(Ga,N(M,a,L))))}
var hb=Za(Oa),ib=fb(Oa,ya),jb=fb(Oa,Ra),kb=gb(Oa),lb=Za(Pa),mb=fb(Pa,ya),nb=fb(Pa,Ra),ob=gb(Pa),pb=Za(Na),qb=gb(Na),rb=fb(Na,Sa),sb=fb(Na,Ta),tb=gb(Qa),ub=gb(Ma),vb=O(N(M,I,N(Ga,Ba))),wb=O(N(M,N(I,[1,I,L],L),La)),xb=O(N(M,I,Ca)),yb=fb(Ra,N(M,Ua,L)),zb=O(N(M,I,Fa)),Ab=O(N(M,J,Ka)),Bb=O(N(M,N(J,N(I,L,I)),Da)),Cb=O(N(J,N(F,I))),Db=O(N(J,N(F,J))),Eb=O(N(J,J)),Fb=O(N(M,I,Xa)),Gb=O(N(M,J,Xa)),Hb=[3,Ja,N()],Ib=[3,Ia,N()];function P(a){for(var b=z,c=a.length-1;0<=c;c--)b=[1,a[c],b];return b}
...
function E(a,b,c,e){function f(K){x(m,K);for(var Q=0;Q<e.length;Q++)x(e[Q],K);return K}function k(){c[1]=!0;return g(Ya)}function g(K){f(K);return S(K)?(e.push(m),E(K,b,[!1,!1],e)):K}function h(){var K={},Q;for(Q in l)K[Q]=!0;for(Q in b)K[Q]=!0;return K}void 0===b&&(b={});void 0===c&&(c=[!1,!1]);void 0===e&&(e=[]);var l={},m=a;for(a=0;S(m)&&32>a;a++)e.push(m),m=U(m);for(;S(m);){a=W(m);if(!0===b[a])return k();if(!0===l[a]){c[0]=!0;if(6===m[0])return k();if(7===m[0]){a=m[1];for(var w=m[2],G=!1,V=0,
pa=[ib,jb,kb,mb,nb,ob,qb,rb,sb,tb,ub];V<pa.length;V++)if(X(pa[V],a)){G=!0;break}if(G)return 1===w.length||n(),!1===c[1]||n(),w=E(w[0],h(),c),c[1]?g(D(a,[w])):n();if(X(a,vb)||X(a,wb)||X(a,xb))return k();if(X(a,zb)&&(3===w.length||n(),!1===c[1]||n(),a=E(w[0],h(),c),c[1]))return g(D(zb,[a,w[1],w[2]]))}else if(8===m[0]||9===m[0])return k();return n()}l[a]=!0;e.push(m);m=U(m)}return f(m)}
...
function X(a,b){function c(e,f,k,g){return X(k(e),k(f))&&X(g(e),g(f))?(x(e,f),!0):!1}if(a===b)return!0;a=E(a);b=E(b);if(a===b)return!0;if(A(a)){if(!A(b))return!1;x(a,b);return!0}return t(a)?t(b)?v(a,b):!1:y(a)?y(b)?c(a,b,ia,ja):!1:C(a)?C(b)?c(a,b,oa,qa):!1:B(a)?B(b)?c(a,b,la,ma):!1:n()}exports.equal_p=X;
...
function W(a){a=R(a);var b;if(A(a))return"()";if(y(a)){var c="(";for(b="";y(a);)c+=b+W(a[1]),b=" ",a=R(a[2]);return c=A(a)?c+")":c+(" . "+W(a)+")")}return B(a)?"#"+W([1,a[1],a[2]]):C(a)?"!"+W([1,a[1],a[2]]):t(a)?fa(a):q(a)?";("+W(a[1])+" "+W(a[2])+")":6===a[0]?"$("+W(Xb(a[1]))+" "+W(a[2])+")":7===a[0]?"%("+W(a[1])+" "+W(P(a[2]))+")":8===a[0]?"@("+W(Xb(a[1]))+" "+W(a[2])+" "+W(P(a[3]))+")":9===a[0]?"^("+W(a[1])+" "+W(P(a[2]))+")":n()}exports.simple_print=W;
function ec(a){function b(){return $a.length===za}function c(){!b()||n();var d=$a[za];za++;return d}function e(d){$a[za-1]===d||n();za--}function f(d){void 0===d&&(d="");throw"TheLanguage parse ERROR!"+d;}function k(d){return" "===d||"\n"===d||"\t"===d||"\r"===d}function g(){if(b())return!1;var d=c();if(!k(d))return e(d),!1;for(;k(d)&&!b();)d=c();k(d)||e(d);return!0}function h(){if(b())return!1;var d=c(),p="";if(!V(d))return e(d),!1;for(;V(d)&&!b();)p+=d,d=c();V(d)?p+=d:e(d);return ea(p)?u(p):f("Not Atom"+
...
var r=c();if(r!==d)return e(r),!1;r=l();if(!1===r||!y(r))return f();var H=r[2];return y(H)&&A(H[2])?p(r[1],H[1]):f()}}function V(d){if(k(d))return!1;for(var p=0,r="()!#.$%^@~/->_:?[]&;".split("");p<r.length;p++)if(r[p]===d)return!1;return!0}function pa(){g();for(var d=0,p=[l,lc,m,w,ab,bb,cb,db,eb];d<p.length;d++){var r=(0,p[d])();if(!1!==r)return r}return f()}function K(d){return!1===d?f():d}function Q(d){K(!b());K(c()===d)}function T(d){function p(){Q("[");var Aa=T();Q("]");return Aa}void 0===d&&
(d=!1);var r=0;for(d=d?[l,h,p,m,w,ab,bb,cb,db,eb]:[l,Kb,m,w,ab,bb,cb,db,eb];r<d.length;r++){var H=(0,d[r])();if(!1!==H)return H}return f()}function Lb(d){if(b())return d;var p=c();if("."===p)return p=T(),N(M,N(I,N(d),L),p);if(":"===p)return p=T(),N(M,p,d);if("~"===p)return N(Ga,d);if("@"===p)return p=T(),N(M,N(I,[1,d,L],L),p);if("?"===p)return N(M,I,N(Ga,d));if("/"===p){for(d=[d];;){p=T(!0);d.push(p);if(b())break;p=c();if("/"!==p){e(p);break}}return N(Ha,P(d))}e(p);return d}function Kb(){if(b())return!1;
var d=c();if("&"===d){K(!b());d=c();if("+"===d)return d=T(),N(J,N(F,d));e(d);d=T();return N(J,d)}if(":"===d){K(!b());d=c();if("&"===d)return Q(">"),d=T(),N(M,N(J,N(I,L,d)),Da);if(">"===d)return d=T(),N(M,N(I,L,d),Da);e(d);d=T();return N(M,d,Da)}if("+"===d)return d=T(),N(F,d);if("["===d)return d=T(),Q("]"),Lb(d);if("_"===d)return Q(":"),d=T(),N(M,d,L);e(d);d=h();return!1===d?!1:Lb(d)}function lc(){var d=Kb();return!1===d?!1:t(d)?d:O(d)}var $a=a,za=0,ab=G("$",function(d,p){var r=Zb(d);return!1===r?
...
function Z(a){function b(f,k){function g(G){return k?"["+G+"]":G}if(t(f))return fa(f);var h=Mb(f);if(!1!==h&&3===h.length&&Y(h[0],M)){var l=Mb(h[1]);if(!1!==l&&3===l.length&&Y(l[0],I)){var m=l[1],w=Mb(m);if(!1!==w&&1===w.length&&Y(l[2],L))return g(b(w[0],!0)+"."+b(h[2],!0));if(y(m)&&Y(m[2],L)&&Y(l[2],L))return g(b(m[1],!0)+"@"+b(h[2],!0));if(Y(m,L)&&Y(h[2],Da))return g(":>"+b(l[2],!0))}m=Mb(h[2]);if(Y(h[1],I)&&!1!==m&&2===m.length&&Y(m[0],Ga))return g(b(m[1],!0)+"?");if(!1!==l&&2===l.length&&Y(h[2],
Da)&&Y(l[0],J)&&(l=Mb(l[1]),!1!==l&&3===l.length&&Y(l[0],I)&&Y(l[1],L)))return g(":&>"+b(l[2],!0));l=void 0;l=Y(h[2],L)?"_":Y(h[2],Da)?"":b(h[2],!0);return g(l+":"+b(h[1],!0))}if(!1!==h&&2===h.length){if(Y(h[0],J))return l=Mb(h[1]),!1!==l&&2===l.length&&Y(l[0],F)?g("&+"+b(l[1],!0)):g("&"+b(h[1],!0));if(Y(h[0],Ga))return g(b(h[1],!0)+"~");if(Y(h[0],F))return g("+"+b(h[1],!0));if(Y(h[0],Ha)&&(h=Mb(h[1]),!1!==h&&1<h.length)){l=b(h[0],!0);for(m=1;m<h.length;m++)l+="/"+b(h[m],!0);return g(l)}}return k?
W(f):W(O(f))}a=ec(W(a));var c="",e="";if(A(a))return"()";if(y(a)){c="(";for(e="";y(a);)c+=e+Z(a[1]),e=" ",a=a[2];return c=A(a)?c+")":c+(" . "+Z(a)+")")}return B(a)?(c=a[1],a=a[2],e=Mb(a),!1!==e&&2===e.length&&Y(c,ya)&&Y(e[0],F)?b(e[1],!1):"#"+Z([1,c,a])):C(a)?"!"+Z([1,a[1],a[2]]):t(a)?fa(a):q(a)?";("+Z(a[1])+" "+Z(a[2])+")":6===a[0]?"$("+Z(Xb(a[1]))+" "+Z(a[2])+")":7===a[0]?"%("+Z(a[1])+" "+Z(P(a[2]))+")":8===a[0]?"@("+Z(Xb(a[1]))+" "+Z(a[2])+" "+Z(P(a[3]))+")":9===a[0]?"^("+Z(a[1])+" "+Z(P(a[2]))+
")":n()}exports.complex_print=Z;
exports.machinetext_parse=function(a){function b(m){void 0===m&&(m="");throw"MT parse ERROR "+m;}function c(m){if(!m)return b()}function e(){c(0!==k);k--;return a[k]}function f(m){var w=g.pop(),G=g.pop();return void 0===G||void 0===w?b():g.unshift(m(G,w))}for(var k=a.length,g=[];0!==k;){var h=e();if("^"===h){for(h="";;){var l=e();if("^"===l)break;h=l+h}if(h in ba())g.unshift([0,h]);else return b('can_new_atom_unicodechar_p("'+h+'") == false')}else if("."===h)f(ha);else if("#"===h)f(ka);else if("!"===
...
exports.machinetext_print=function(a){function b(){for(var f=[],k=0,g=c;k<g.length;k++){var h=g[k];h=R(h);var l=function(m,w,G,V){e+=w;return f.push(G(m),V(m))};if(t(h))e+="^"+h[1]+"^";else if(y(h))l(h,".",ia,ja);else if(A(h))e+="_";else if(B(h))l(h,"#",la,ma);else if(C(h))l(h,"!",oa,qa);else if(Nb(h))h=Ob(h),l(h,"$",function(m){return Xb(m[1])},sa);else return{value:n()}}c=f}for(var c=[a],e="";0!==c.length;)if(a=b(),"object"===typeof a)return a.value;return e};exports.Trampoline=function(){};
function fc(a){return function(){return[!1,a]}}exports.trampoline_return=fc;function gc(a){return function(){return[!0,a()]}}exports.trampoline_delay=gc;function hc(a){for(a=a();a[0];)a=a[1]();return a[1]}exports.run_trampoline=hc;var ic=O([1,Ha,[1,[1,Wa,[1,[1,M,[1,Ua,[1,L,z]]],z]],z]]);exports.return_effect_systemName=ic;var jc=O([1,Ha,[1,[1,Wa,[1,Na,z]],z]]);exports.bind_effect_systemName=jc;exports.new_effect_bind=function(a,b){return[3,jc,N(a,b)]};
...
e,function(G,V){return gc(function(){return kc(a,b,ta(f,[G]),V)})})})}exports.run_monad_trampoline=function(a,b,c,e){return kc(a,b,c,e)};exports.run_monad_stackoverflow=function(a,b,c,e){return hc(kc(function(f,k){return fc(a(f,k))},function(f,k,g){return fc(b(f,k,function(h,l){return hc(g(h,l))}))},c,e))};
