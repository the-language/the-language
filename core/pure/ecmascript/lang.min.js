...
function ua(a){a=E(a);if(B(a)||C(a)||y(a)||q(a))a[1]=ua(a[1]),a[2]=ua(a[2]);return a}exports.force_all_rec=ua;function va(a){var b=wa(a);if(B(b)||C(b)||y(b))if(b[1]=ua(b[1]),b[2]=ua(b[2]),q(b[1])||q(b[2])){a=[10];xa(a,b);var c=b[2];b=va(b[1]);c=va(c);a[1]=b;a[2]=c}else a=b;else a=b;return a}exports.force_uncomment_all_rec=va;function x(a,b){a!==b&&(a===z&&(a=b,b=z),a[0]=5,a[1]=b,a[2]=!1,a[3]=!1)}function xa(a,b){10===a[0]||n();10!==b[0]||n();a[0]=b[0];a[1]=b[1];a[2]=b[2];a[3]=b[3]}
...
function E(a,b,c,e){function f(L){x(m,L);for(var Q=0;Q<e.length;Q++)x(e[Q],L);return L}function k(){c[1]=!0;return g(Ya)}function g(L){f(L);return S(L)?(e.push(m),E(L,b,[!1,!1],e)):L}function h(){var L={},Q;for(Q in l)L[Q]=!0;for(Q in b)L[Q]=!0;return L}void 0===b&&(b={});void 0===c&&(c=[!1,!1]);void 0===e&&(e=[]);var l={},m=a;for(a=0;S(m)&&32>a;a++)e.push(m),m=U(m);for(;S(m);){a=W(m);if(!0===b[a])return k();if(!0===l[a]){c[0]=!0;if(6===m[0])return k();if(7===m[0]){a=m[1];for(var w=m[2],G=!1,V=0,
