...
extern "C" {
  ...
  extern lang_value *lang_machinetext_parse_orNULL(lang_state *L, const char *str);
  ...
  extern char *lang_machinetext_print_retMalloc_orNULL(lang_state *L, lang_value *val);
