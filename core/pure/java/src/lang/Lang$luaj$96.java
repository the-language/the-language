package lang;
public class Lang$luaj$96 extends org.luaj.vm2.lib.VarArgFunction {
    ...
    final public org.luaj.vm2.Varargs onInvoke(org.luaj.vm2.Varargs a) {
        ...
        if (!this.u2.call(a3).toboolean() && !this.u2.call(a4).toboolean()) {
            ...
            Lang$luaj$96$H_if a6 = new Lang$luaj$96$H_if();
            a6.u0 = this.u3;
            a6.u1 = this.u5;
            Lang$luaj$96$H_and a7 = new Lang$luaj$96$H_and();
            a7.u0 = a6;
            a7.u1 = this.u6;
            this.u7.call(this.u2.call(a3).not());
            Lang$luaj$96$end_2 a8 = new Lang$luaj$96$end_2();
            a8.u0 = a7;
            a8.u1 = this.u3;
            a8.u2 = this.u4;
