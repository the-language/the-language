package lang;
public class Lang$luaj$w extends org.luaj.vm2.lib.VarArgFunction {
    ...
    final public org.luaj.vm2.Varargs onInvoke(org.luaj.vm2.Varargs a) {
        ...
        org.luaj.vm2.LuaValue[] a4 = Lang$luaj$w.newupe();
        a4[0] = a3;
        ...
        while(!((org.luaj.vm2.LuaValue)a2).len().eq_b(k0)) {
            ...
            while(true) {
                ...
                if (a12.testfor_b(a10, a11)) {
                    ...
                    Lang$luaj$w$3 a15 = new Lang$luaj$w$3();
                    a15.u0 = this.u0;
                    a15.u1 = this.u1;
                    a15.u2 = a8;
                    a15.u3 = this.u2;
                    ...
                    if (a14.eq_b(k2)) {
                        ...
                        Lang$luaj$w$4 a21 = new Lang$luaj$w$4();
                        a21.u0 = this.u8;
                        a21.u1 = this.u9;
                        a21.u2 = this.u10;
                        a21.u3 = this.u11;
