...
public class Lang$luaj$81 extends org.luaj.vm2.lib.VarArgFunction {
    ...
    org.luaj.vm2.LuaValue u45;
    org.luaj.vm2.LuaValue u46;
    org.luaj.vm2.LuaValue u47;
    ...
    final public org.luaj.vm2.Varargs onInvoke(org.luaj.vm2.Varargs a) {
        ...
        Lang$luaj$81$print_sys_name a1 = new Lang$luaj$81$print_sys_name();
        a1.u0 = this.u0;
        a1.u1 = this.u1;
        a1.u2 = this.u2;
        a1.u3 = this.u3;
        ...
        if (this.u8.call(a2).toboolean()) {
            ...
            while(this.u8.call(a2).toboolean()) {
                a4 = this.u2.get(k3).call(a4).concat(this.u2.get(k3).call(a5).concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u10.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).arg1().buffer())).value();
                a5 = k4;
                a2 = this.u9.call(a2);
            }
            org.luaj.vm2.Varargs a6 = (this.u19.call(a2).toboolean()) ? this.u2.get(k3).call(a4).concat(k5) : this.u2.get(k3).call(a4).concat(k6.concat(this.u2.get(k3).invoke(this.u20[0].invoke((org.luaj.vm2.Varargs)a2).subargs(1)).arg1().concat(k5.buffer()))).value();
            return a6;
            ...
            if (!a9.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a9.len().eq_b(k7) && this.u4[0].call(a7, this.u24[0]).toboolean() && this.u4[0].call(a9.get(k8), this.u14[0]).toboolean()) {
            ...
            org.luaj.vm2.Varargs a10 = k9.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u25.invoke(a7, (org.luaj.vm2.Varargs)a8).subargs(1)).subargs(1)).arg1());
            return a10;
        } else {
            if (this.u26.call(a2).toboolean()) {
                org.luaj.vm2.LuaValue a11 = k10;
                org.luaj.vm2.LuaValue a12 = this.u2.get(k3);
                org.luaj.vm2.LuaValue a13 = this.u20[0];
                org.luaj.vm2.LuaValue a14 = this.u25;
                org.luaj.vm2.LuaValue a15 = this.u27.call(a2);
                org.luaj.vm2.Varargs a16 = this.u28.invoke((org.luaj.vm2.Varargs)a2);
            ...
            if (this.u29.call(a2).toboolean()) {
                org.luaj.vm2.Varargs a19 = k11.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u30.invoke(this.u31.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u32.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))).value();
                return a19;
            }
            if (this.u33.call(a2).toboolean()) {
                org.luaj.vm2.Varargs a20 = k12.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u34.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u35.invoke(this.u36.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))).value();
                return a20;
            }
            if (this.u37.call(a2).toboolean()) {
                org.luaj.vm2.Varargs a21 = k13.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u30.invoke(this.u38.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u39.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u35.invoke(this.u40.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))))).value();
                return a21;
            }
            if (this.u41.call(a2).toboolean()) {
                org.luaj.vm2.Varargs a22 = k14.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u42.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u35.invoke(this.u43.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))).value();
                return a22;
            }
            if (!this.u44.call(a2).toboolean()) {
                return org.luaj.vm2.LuaValue.tailcallOf(this.u47, (org.luaj.vm2.Varargs)org.luaj.vm2.LuaValue.NONE);
            }
            org.luaj.vm2.Varargs a23 = k15.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u45.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u2.get(k3).invoke(this.u20[0].invoke(this.u46.invoke((org.luaj.vm2.Varargs)a2).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))).value();
            return a23;
        }
    }
}
