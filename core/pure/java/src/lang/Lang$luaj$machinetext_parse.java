...
public class Lang$luaj$machinetext_parse extends org.luaj.vm2.lib.VarArgFunction {
    ...
    final public org.luaj.vm2.Varargs onInvoke(org.luaj.vm2.Varargs a) {
        org.luaj.vm2.LuaValue[] a0 = Lang$luaj$machinetext_parse.newupn();
        ...
        while(!((org.luaj.vm2.LuaValue)a2).len().eq_b(k1)) {
            ...
            while(true) {
                ...
                if (a7.testfor_b(a5, a6)) {
                    ...
                    Lang$luaj$machinetext_parse$0 a10 = new Lang$luaj$machinetext_parse$0();
                    a10.u0 = a0;
                    a10.u1 = this.u1;
                    a10.u2 = a3;
                    if (this.u2.call(a9).toboolean()) {
                        a0[0] = this.u1.get(k3).call(a0[0]).concat(k4);
                        a0[0] = this.u1.get(k3).call(a0[0]).concat(this.u1.get(k3).invoke(this.u3.invoke((org.luaj.vm2.Varargs)a9).subargs(1)).arg1());
                        a0[0] = this.u1.get(k3).call(a0[0]).concat(k4);
                    } else if (this.u4.call(a9).toboolean()) {
                        org.luaj.vm2.LuaValue a11 = k5;
                        org.luaj.vm2.LuaValue a12 = this.u5;
                    ...
                    } else if (this.u11.call(a9).toboolean()) {
                        org.luaj.vm2.LuaValue a19 = k8;
                        org.luaj.vm2.LuaValue a20 = this.u12;
                        org.luaj.vm2.LuaValue a21 = this.u13;
                        ...
                        if (!this.u14.call(a9).toboolean()) {
                            return org.luaj.vm2.LuaValue.tailcallOf(this.u19, (org.luaj.vm2.Varargs)org.luaj.vm2.LuaValue.NONE);
                        }
                        org.luaj.vm2.LuaValue a23 = this.u15.call(a9);
                        org.luaj.vm2.LuaValue a24 = k9;
                        Lang$luaj$machinetext_parse$1 a25 = new Lang$luaj$machinetext_parse$1();
                        a25.u0 = this.u16;
                        a25.u1 = this.u17;
                        org.luaj.vm2.LuaValue a26 = this.u18;
