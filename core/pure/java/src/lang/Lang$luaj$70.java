    ...
    final public org.luaj.vm2.Varargs onInvoke(org.luaj.vm2.Varargs a) {
        ...
        if (this.u2.call(a1).toboolean()) {
            ...
            if (!this.u16.call(a1).toboolean()) {
                if (this.u17.call(a1).toboolean()) {
                    org.luaj.vm2.Varargs a22 = k9.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u18.invoke(this.u19.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u20.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))).value();
                    return a22;
                }
                if (this.u21.call(a1).toboolean()) {
                    org.luaj.vm2.Varargs a23 = k10.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u22.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u23.invoke(this.u24.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))).value();
                    return a23;
                }
                if (this.u25.call(a1).toboolean()) {
                    org.luaj.vm2.Varargs a24 = k11.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u18.invoke(this.u26.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u27.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u23.invoke(this.u28.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))))).value();
                    return a24;
                }
                if (this.u29.call(a1).toboolean()) {
                    org.luaj.vm2.Varargs a25 = k12.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u30.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).arg1().concat(k4.concat(this.u3.get(k3).invoke(this.u4[0].invoke(this.u23.invoke(this.u31.invoke((org.luaj.vm2.Varargs)a1).subargs(1)).subargs(1)).subargs(1)).arg1().concat(k5.buffer())))).value();
                    return a25;
                }
            }
