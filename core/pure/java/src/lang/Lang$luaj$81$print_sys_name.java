package lang;
public class Lang$luaj$81$print_sys_name extends org.luaj.vm2.lib.VarArgFunction {
    ...
    public Lang$luaj$81$print_sys_name() {
    }
    ...
    final public org.luaj.vm2.Varargs onInvoke(org.luaj.vm2.Varargs a) {
        ...
        Lang$luaj$81$print_sys_name$inner_bracket a2 = new Lang$luaj$81$print_sys_name$inner_bracket();
        a2.u0 = a1;
        a2.u1 = this.u2;
        org.luaj.vm2.LuaValue a3 = this.u3.call(a0);
        if (!a3.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a3.len().eq_b(k0) && this.u4[0].call(a3.get(k1), this.u5[0]).toboolean()) {
            ...
            if (!a5.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a5.len().eq_b(k0) && this.u4[0].call(a5.get(k1), this.u6[0]).toboolean()) {
                ...
                if (!a7.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a7.len().eq_b(k1) && this.u4[0].call(a5.get(k0), this.u7[0]).toboolean()) {
                ...
                if (this.u9.call(a6).toboolean() && this.u4[0].call(this.u10.call(a6), this.u7[0]).toboolean() && this.u4[0].call(a5.get(k0), this.u7[0]).toboolean()) {
                ...
                if (this.u4[0].call(a6, this.u7[0]).toboolean() && this.u4[0].call(a3.get(k0), this.u12[0]).toboolean()) {
            ...
            if (this.u4[0].call(a3.get(k2), this.u6[0]).toboolean() && !a8.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a8.len().eq_b(k2) && this.u4[0].call(a8.get(k1), this.u13[0]).toboolean()) {
            ...
            if (!a5.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a5.len().eq_b(k2) && this.u4[0].call(a3.get(k0), this.u12[0]).toboolean() && this.u4[0].call(a5.get(k1), this.u14[0]).toboolean()) {
                org.luaj.vm2.LuaValue a9 = this.u3.call(a5.get(k2));
                if (!a9.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a9.len().eq_b(k0) && this.u4[0].call(a9.get(k1), this.u6[0]).toboolean() && this.u4[0].call(a9.get(k2), this.u7[0]).toboolean()) {
            ...
            boolean b = this.u4[0].call(a3.get(k0), this.u7[0]).toboolean();
            label0: {
                label3: {
                    label4: {
                        if (b) {
                ...
                boolean b0 = this.u4[0].call(a3.get(k0), this.u12[0]).toboolean();
                label2: {
                    label1: {
                        if (b0) {
                            break label1;
        ...
        if (!a3.eq_b((org.luaj.vm2.LuaValue)org.luaj.vm2.LuaValue.FALSE) && a3.len().eq_b(k2)) {
            ...
            if (this.u4[0].call(a3.get(k1), this.u13[0]).toboolean()) {
            ...
            if (this.u4[0].call(a3.get(k1), this.u16[0]).toboolean()) {
