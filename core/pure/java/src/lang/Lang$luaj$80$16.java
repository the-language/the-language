package lang;
public class Lang$luaj$80$16 extends org.luaj.vm2.lib.VarArgFunction {
    ...
    final public org.luaj.vm2.Varargs onInvoke(org.luaj.vm2.Varargs a) {
        ...
        if (a2.eq_b(k0)) {
            ...
            return org.luaj.vm2.LuaValue.tailcallOf(this.u3, org.luaj.vm2.LuaValue.varargsOf(this.u4[0], this.u3.call(this.u5[0], this.u3.call(a0), this.u6[0]), (org.luaj.vm2.Varargs)a3));
        }
        if (a2.eq_b(k1)) {
            org.luaj.vm2.LuaValue a4 = this.u2[0].call();
            return org.luaj.vm2.LuaValue.tailcallOf(this.u3, org.luaj.vm2.LuaValue.varargsOf(this.u4[0], a4, (org.luaj.vm2.Varargs)a0));
        }
        if (a2.eq_b(k2)) {
            return org.luaj.vm2.LuaValue.tailcallOf(this.u3, org.luaj.vm2.LuaValue.varargsOf(this.u7[0], (org.luaj.vm2.Varargs)a0));
        }
        if (a2.eq_b(k3)) {
            org.luaj.vm2.LuaValue a5 = this.u2[0].call();
            return org.luaj.vm2.LuaValue.tailcallOf(this.u3, org.luaj.vm2.LuaValue.varargsOf(this.u4[0], this.u3.call(this.u5[0], this.u8.call(a0, this.u6[0]), this.u6[0]), (org.luaj.vm2.Varargs)a5));
        }
        if (a2.eq_b(k4)) {
            org.luaj.vm2.LuaValue a6 = this.u3;
            org.luaj.vm2.LuaValue a7 = this.u4[0];
            org.luaj.vm2.LuaValue a8 = this.u5[0];
            org.luaj.vm2.Varargs a9 = this.u3.invoke(this.u7[0], (org.luaj.vm2.Varargs)a0);
        ...
        while(true) {
            ...
            org.luaj.vm2.LuaValue a16 = this.u11[0];
