...
export type LangValComment = [LangValType.comment_t, LangValRec, LangValRec]
...
function new_comment(comment: LangVal, x: LangVal): LangValComment {
    return [comment_t, comment, x]
}
function comment_p(x: LangVal): x is LangValComment {
    return x[0] === comment_t
}
function comment_comment(x: LangValComment): LangVal {
    return x[1]
}
function comment_x(x: LangValComment): LangVal {
    return x[2]
}
